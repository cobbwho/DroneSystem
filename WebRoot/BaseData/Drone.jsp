		...
		$(function(){			
			$('#table2').datagrid({
				...
				columns:[[
					...
					{field:'Manufacturer',title:'制造厂',width:60,align:'center'},
					{field:'Model',title:'型号',width:100,align:'center'},
					{field:'Weight',title:'重量',width:80,align:'center'},
					{field:'Height',title:'飞行高度',width:80,align:'center'},
					{field:'IsTask',title:'执行任务',width:80,align:'center'},
					{field:'Longitude',title:'经度',width:80,align:'center'},
					{field:'Latitude',title:'纬度',width:80,align:'center'},
					{field:'VideoUrl',title:'视频地址',width:80,align:'center'},
				...
				<div>
					...
					<input id="Id" name="Id" type="hidden"/>
						<tr>
                            ...
                            <td align="right">制造厂：</td>
							<td align="left"><input id="Manufacturer" name="Manufacturer" class="easyui-validatebox"/></td>
						</tr>
						<tr>
							<td align="right">型&nbsp;&nbsp;&nbsp;&nbsp;号：</td>
							<td align="left"><input id="Model" name="Model" class="easyui-validatebox"/></td>
							<td align="right">重&nbsp;&nbsp;&nbsp;&nbsp;量：</td>
							<td align="left"><input id="Weight" name="Weight" class="easyui-validatebox"/></td>
                            </tr>
                        <tr>
                            <td align="right">飞行高度：</td>
							<td align="left"><input id="Height" name="Height" class="easyui-validate"/></td>
                            <td align="right">视频地址：</td>
							<td align="left"><input id="VideoUrl" name="VideoUrl" class="easyui-validate"/></td>
						</tr>
                        <tr>
