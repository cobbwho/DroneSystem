 ...
 * 
 * @see com.droneSystem.hibernate.Role
...
public class RoleDAO extends BaseHibernateDAO {
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) getSession().get("com.droneSystem.hibernate.Role",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Role instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.droneSystem.hibernate.Role").add(Example.create(instance))
					.list();
